      ...
      return (
        ...
        >
          ...
          {(imageMobile.base64 && imageDesktop.base64) && (
            <>
              <ImgFluidOnlyMobile className={`${placeholderClassName || ''}`} src={imageMobile.base64} {...placeholderImageProps} />
              <ImgFluidOnlyDesktop className={`${placeholderClassName || ''}`} src={imageDesktop.base64} {...placeholderImageProps} />
            </>
          )}
          ...
          {(imageMobile.tracedSVG && imageDesktop.tracedSVG) && (
            <>
              <ImgFluidOnlyMobile className={`${placeholderClassName || ''}`} src={imageMobile.tracedSVG} {...placeholderImageProps} />
              <ImgFluidOnlyDesktop className={`${placeholderClassName || ''}`} src={imageDesktop.tracedSVG} {...placeholderImageProps} />
            </>
          )}
          ...
          {this.state.hasNoScript && (
            <noscript
              dangerouslySetInnerHTML={{
                __html: noscriptImgMobile({ ...imageMobile }) +
                  noscriptImgDesktop({
                    alt,
                    title,
                    ...imageDesktop,
    ...
    `
      ...
      return (
        <>
          ...
          `}</style>
          <Tag
            className={`${className ? className : ``} fixed-${wrapClass} gatsby-image-wrapper`}
            style={divStyle}
            ref={this.handleRef}
          ...
          >
            ...
            {(imageMobile.base64 && imageDesktop.base64) && (
              <>
                <ImgFixedOnlyMobile className={`${placeholderClassName || ''}`} src={imageMobile.base64} {...placeholderImageProps} />
                <ImgFixedOnlyDesktop className={`${placeholderClassName || ''}`} src={imageDesktop.base64} {...placeholderImageProps} />
              </>
            )}
            ...
            {(imageMobile.tracedSVG && imageDesktop.tracedSVG) && (
              <>
                <ImgFixedOnlyMobile className={`${placeholderClassName || ''}`} src={imageMobile.tracedSVG} {...placeholderImageProps} />
                <ImgFixedOnlyDesktop className={`${placeholderClassName || ''}`} src={imageDesktop.tracedSVG} {...placeholderImageProps} />
              </>
            )}
